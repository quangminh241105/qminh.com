    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="mt-8 grid gap-4">
        {portfolio.resume.map((item) => (
          ...
          >
            ...
            <h3 className="mt-1 text-xl font-semibold text-slate-800 dark:text-slate-100">{item.title}</h3>
      ...
      <div className="mt-8">
        <Button
          href="/resume.txt"
          variant="secondary"
          className="border-brand-600 text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-900/30"
        >
          Download Resume (TXT)
        </Button>
      </div>
